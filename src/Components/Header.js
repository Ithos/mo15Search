...
const Header = ({title, width, legalSets, banList, format, homeLink, legalSetsLink, banListLink, formatLink, smallScreenWidth, menuState, setMenuState}) => {
    ...
    return (
        <header className='Header' ref={headerRef} onBlur={handleBlur}>
            ...
            <Nav 
                ...
                banList={banList} 
                format={format}
                legalSetsLink={legalSetsLink} 
                banListLink={banListLink} 
